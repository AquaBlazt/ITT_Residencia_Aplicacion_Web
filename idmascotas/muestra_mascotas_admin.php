...
<?php if ($registro_mascota) : ?>
    ...
    <a href="edicion_mascotas_admin.php?id=<?= $registro_mascota->id; ?>">Editar</a>
    <a href="delete_mascotas_admin.php?id=<?= $registro_mascota->id; ?>">Eliminar</a>
    <a href="foto_admin.php?id=<?= $registro_mascota->id; ?>">Foto</a>
